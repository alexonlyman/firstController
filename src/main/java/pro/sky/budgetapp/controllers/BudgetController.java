...
public class BudgetController {
    ...
    @GetMapping("/vocation/salary")
    public int salaryWithVacation(@RequestParam int vacationDays, @RequestParam int workingDays, @RequestParam int vacWorDays) {

        return budgetService.getSalaryWithVacation(vacationDays, vacWorDays, workingDays);
    }
}
